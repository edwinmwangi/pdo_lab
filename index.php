...
<div id="main">
    ...
    <div id="login">
        ...
        <form action="" method="post">
            ...
            <input type="email" name="stu_email" id="email" required="required"
                   placeholder="john123@gmail.com"/><br/><br/>
...
if (isset($_POST["submit"])) {
    ...
    try {
        $pdo = new PDO("mysql:host=$hostname;dbname=college", $username, $password);
